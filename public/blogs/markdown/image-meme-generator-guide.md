...
2. Upload an image by clicking the preview area or dragging a file onto it.
...
- Keep strong contrast between text and background; add outlines or shadows if the text blends into the image.
- All composition occurs client-side — your image and text do not leave your device unless you choose to upload or share.
